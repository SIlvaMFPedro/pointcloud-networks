...
import provider
from part_seg import pointnet_part_seg as model

# Construct a argument parser and parse the arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model_path', default='train_results\\trained_models\\epoch_190.ckpt',
...
gpu_to_use = 0
output_dir = os.path.join(BASE_DIR, '.\\test_results')
...
def predict():
    ...
    with tf.device('/gpu:' + str(gpu_to_use)):
        ...
        # simple model
        pred, seg_pred, end_points = model.get_model(pointclouds_ph, input_label_ph, cat_num=NUM_OBJ_CATS,
