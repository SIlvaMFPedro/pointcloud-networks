...
from utils.plyfile import PlyData, PlyElement, PlyParseError, PlyProperty, make2d
import numpy as np
import h5py
...
# --------------------------------------------------------------
#   HELPER FUNCTIONS TO LOAD MODELNET40 SHAPES
# --------------------------------------------------------------
...
# ----------------------------------------------------------------
#   HELPER FUNCTIONS TO LOAD SAVE/LOAD .PLY FILES
# ----------------------------------------------------------------
# Load PLY file
