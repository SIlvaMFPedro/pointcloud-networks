...
# ----------------------------------------
# Point Cloud/Volume Conversion Functions
# ----------------------------------------
...
# ------------------------------------------------
# Simple Point cloud and Volume Renderer Functions
# ------------------------------------------------

def draw_point_cloud(input_points, canvasSize=500, space=200, diameter=25, xrot=0, yrot=0, zrot=0,
                     switch_xyz=[0, 1, 2], normalize=True):
    """
    ...
    # Normalize the point cloud by normalizing scale to fit points in a unit sphere
    if normalize:
...
def point_cloud_three_views_demo():
    ...
    """
    points = read_ply('..\\third_party\\mesh_sampling\\piano.ply')
